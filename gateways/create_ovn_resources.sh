...
ovn-nbctl lrp-add router1 router1-net1 40:44:00:00:00:02 192.168.0.1/24
...
ovn-nbctl lrp-add router1 router1-public 40:44:00:00:00:03 10.0.0.45/24
...
ovn-nbctl lr-nat-add router1 snat 10.0.0.45 192.168.0.0/24
ovn-nbctl lr-nat-add router1 dnat_and_snat 10.0.0.11 192.168.0.11
